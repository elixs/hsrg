...
APlayerCharacter::APlayerCharacter()
{
	...
	CameraBoom->SocketOffset.Z = 100.f;
...
void APlayerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnLeftRate", this, &APlayerCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("TurnRightRate", this, &APlayerCharacter::TurnAtRate);
...
void APlayerCharacter::TurnAtRate(float Rate)
{
	...
	float CameraDirection = bInvertCamera ? -1.0 : 1.0;

	AddControllerYawInput(CameraDirection * Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}
